...
<caption>Server :</caption>
  ...
  <tr>
    ...
    <td align="left"><?php echo client::getUserOs(); ?></td>
  </tr>
  <tr>
    <td width="10" height="30">&nbsp;</td>
  ...
  <tr>
	...
	if (is_dir(WEBAPP_ROOT)) {
		echo is_writable(WEBAPP_ROOT) ? html::image($this->getAssetUrl('images') . 'check_right.gif') . ' <span class="green">' . WEBAPP_ROOT . '</span> (支持文件写入操作)' :  html::image($this->getAssetUrl('images') . 'check_error.gif') . ' <span class="red"><b>'. WEBAPP_ROOT . '</b></span>  (注:<span class="red">当前目录没有文件写入权限!</span>)';
	} else {
