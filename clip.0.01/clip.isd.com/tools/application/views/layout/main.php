...
<div class="text-align-right" style="padding-right:15px;">欢迎使用: <span class="blue">DoitPHP Tools</span>( <?php if(DOIT_VERSION == 'normal'){echo '标准版';} else if(DOIT_VERSION == 'mysql'){echo 'Mysql专业版';}else if(DOIT_VERSION == 'sae'){echo 'SAE版';}?> )&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->createUrl('login/logout'); ?>">退出</a></div>
<!-- main menu-->
<?php $this->widget('main_menu'); ?>
<!-- /main menu-->
</div>
<hr class="space"/>
<!-- /top -->
...
<!-- /content -->
<!-- footer-->
<div class="footer">CopyRight <a href="http://www.doitphp.com" target="_blank">www.doitphp.com</a> 2010 - 2011</div>
<!-- /footer-->
</div>
<!-- /total-->
</body>
