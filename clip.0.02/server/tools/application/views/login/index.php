...
$(document).ready(function(){$('#login_box').ajaxForm({beforeSubmit:showRequest,success:showResponse});$('#login_box').resetForm();});
...
function showResponse(data){
	switch(data){
		case '105':
			...
			break;
		case '101':			
			location.href='<?php echo $this->createUrl('index/index'); ?>';
			break;
		case '100':
			alert('用户名或密码错误!');
			break;
...
<div class="login_box">
  <table width="400" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
   ...
   <table width="400" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
   <form action="<?php echo $this->getActionUrl('handle_login'); ?>" method="post" name="login_box" id="login_box">
    <tr>
