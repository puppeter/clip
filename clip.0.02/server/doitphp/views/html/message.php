...
.main{padding:30px; height:260px; width:540px; margin-top:70px; margin-right:auto; margin-bottom:0px; margin-left:auto; text-align:left; background-color:#FFF; border:1px solid #CCC}
.main .box{margin:0px; padding:0px; height:260px; width:540px; border-top-style:none; border-right-style:none; border-bottom-style:none; border-left-style:none}
...
.main .box ul .content{font-size:14px;height:120px; width:500px; border-top-style:none; border-right-style:none; border-bottom-style:none; border-left-style:none; background-color:#F5F5F5; margin:0px; padding:20px; color:#C00}
...
<li class="content"><?php echo $message; ?></li>
<li class="line"></li>
<li class="bottom"><a href="http://www.doitphp.com" target="_blank">Powered By DoitPHP</a></li>
</ul>
</div>
</div>
</body>
