 ...
 * player class file
 *
 * 常用网页播放器:mp3,flv播放器及幻灯片效果
 * @author tommy <streen003@gmail.com>
 * @copyright  Copyright (c) 2010 Tommy Software Studio
 * @link http://www.doitphp.com
 * @license New BSD License.{@link http://www.opensource.org/licenses/bsd-license.php}
 * @version $Id: player.class.php 1.3 2011-11-13 21:16:01Z tommy $
 * @package libraries
 * @since 1.0
 */
...
class player extends Base {
    ...
    public static function mp3Player($fileUrl, $width = null, $height = null, $autoPlay=false) {
        ...
        //参数分析
        $width        = is_null($width) ? 290 : $width;
        $height       = is_null($height) ? 24 : $height;
...
EOT;
    ...
    public static function flvPlayer($fileUrl, $width = null, $height = null) {
        ...
        $height       = is_null($height) ? 300 : $height;
